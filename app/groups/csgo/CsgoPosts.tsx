...
export default function CsgoPosts({
  avatar,
  belonging,
  name,
  image,
  ...
  return (
    <div className="bg-customBlue  my-4 p-4 rounded-xl xl:w-2/3 md:w-1/2 w-3/4">
      <Link className="w-1/2" href={`/user/${userId}`}>
        <div className="flex items-center gap-2">
          <Image
            ...
            alt="avatar"
          />
          <h3 className="font-bold text-[#F29A1C]">{name}</h3>
          <h2 className="text-white">{belonging}</h2>
        </div>
      </Link>
      <div className="mt-8">
